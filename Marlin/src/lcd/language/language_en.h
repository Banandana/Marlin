...
namespace Language_en {
  ...
  LSTR MSG_PRINTING_OBJECT                = _UxGT("Running task");
  ...
  LSTR MSG_PRINT_PAUSED                   = _UxGT("Paused");
  LSTR MSG_PRINTING                       = _UxGT("Executing...");
  LSTR MSG_STOPPING                       = _UxGT("Stopping...");
  LSTR MSG_REMAINING_TIME                 = _UxGT("Remaining");
  LSTR MSG_PRINT_ABORTED                  = _UxGT("Aborted");
  LSTR MSG_PRINT_DONE                     = _UxGT("Done");
  ...
  LSTR MSG_INFO_MENU                      = _UxGT("About");
  LSTR MSG_INFO_PRINTER_MENU              = _UxGT("Info");
  ...
  LSTR MSG_KILL_EXPECTED_PRINTER          = _UxGT("INCORRECT PRINTER");
    ...
    LSTR MSG_INFO_PRINT_COUNT             = _UxGT("Count");
  ...
  LSTR MSG_FILAMENT_CHANGE_HEADER_PAUSE   = _UxGT("PAUSED");
