...
namespace Language_en {
  ...
  LSTR MSG_PAUSE_PRINT                    = _UxGT("Pause Job");
  LSTR MSG_ADVANCED_PAUSE                 = _UxGT("Advanced Pause");
  LSTR MSG_RESUME_PRINT                   = _UxGT("Resume Job");
  ...
  LSTR MSG_PRINTER_KILLED                 = _UxGT("Killed!");
  ...
  LSTR MSG_PLEASE_WAIT_REBOOT             = _UxGT("Please wait until reboot.");
    ...
    LSTR MSG_INFO_PRINT_COUNT_RESET       = _UxGT("Reset Job Count");
